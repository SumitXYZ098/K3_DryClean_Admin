    ...
    <div className={`space-y-sm ${containerClassName}`}>
      ...
      <div className="relative group">
        ...
        <input
          ...
          } ${rightElement ? "pr-12" : "pr-md"} py-3 bg-surface border border-outline-variant rounded-lg font-body-md text-body-md text-on-surface focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/10 input-glow transition-all ${
